...
interface BluweLogoSvgProps {
  height?: number;
  width?: number;
}

export const BluweLogoSvg: React.FC<BluweLogoSvgProps> = ({ height = 60, width = 60 }) => {
  // Mantém a proporção do viewBox original (240x240)
  const aspectRatio = 1; // Proporção 1:1 para o formato quadrado
  ...
  return (
    <svg 
      ...
      aria-labelledby="bluwe-logo-title"
      role="img"
    >
      <title id="bluwe-logo-title">Bluwe Logo</title>
...
// Exportação padrão mantida para compatibilidade com importações existentes
export default BluweLogoSvg;
